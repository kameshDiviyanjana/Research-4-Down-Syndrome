...
function Footer() {
  return (
    <div className=" w-full h-full bg-[#1C4596] lg:py-16 px-11">
      {" "}
      <div className=" grid md:grid-cols-1 xl:grid-cols-2 gap-6 lg:ml-10 lg:mr-10">
        <div>
        ...
        <div className="flex flex-wrap lg:gap-11 gap-6 lg:p-4 ">
          {/* First Menu Section */}
          <div>
          ...
          {/* Contact Section */}
          <div className=" md:p-2 lg:p-6 max-w-sm w-full bg-white rounded-lg shadow-md">
