...
const AllWordList = () => {
  ...
  return (
    <div className="bg-cover bg-center h-screen bg-[url(https://cdn.pixabay.com/photo/2022/06/22/11/45/background-7277773_1280.jpg)] bg-cover bg-no-repeat bg-center lg:h-[700px] w-full">
